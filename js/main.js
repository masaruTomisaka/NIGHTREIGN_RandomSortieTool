// ===== キャラ定義（key/ファイル名は英名、表示は和名） =====
  ...
  const STAGES = [
    // 通常（本編）
    { name:"三つ首の獣",       type:"通常",   dlc:false, img:"https://img.gamewith.jp/img/5be58aa5bb22342c03ca1ab20171de64.png" },
    { name:"喰らいつく顎",     type:"通常",   dlc:false, img:"https://img.gamewith.jp/img/fe592489b2c001299bc31fa060fb2e9f.png" },
    { name:"知性の蟲",         type:"通常",   dlc:false, img:"https://img.gamewith.jp/img/f142d8630b6eb6587b69de6f4530c603.png" },
    { name:"兆し",             type:"通常",   dlc:false, img:"https://img.gamewith.jp/img/b3f0232284df2d549777e3f32af5927f.png" },
    { name:"調律の魔物",       type:"通常",   dlc:false, img:"https://img.gamewith.jp/img/64cd7fbafccf7116d1004f2cd7da9023.png" },
    { name:"闇駆ける狩人",     type:"通常",   dlc:false, img:"https://img.gamewith.jp/img/4fdfba64d501eeea9d4d053d37091828.jpg" },
    { name:"霧の裂け目",       type:"通常",   dlc:false, img:"https://img.gamewith.jp/img/769309700c3f36cfcad4f304632aa219.png" },
    { name:"夜を象る者",       type:"通常",   dlc:false, img:"https://img.gamewith.jp/img/8b4d1ec87e3760bc97931c5446d70868.png" },

    // 通常（DLC）
    { name:"安寧者たち", type:"通常", dlc:true, img:"https://img.gamewith.jp/img/a5ff91b5bce189ea26552e571b176723.png" },
    { name:"瓦礫の王",   type:"通常", dlc:true, img:"https://img.gamewith.jp/img/6660b03a33990ae9ff2437f63e3289cc.png" },

    // 常夜（日替わり枠：①〜③）
    { name:"常夜①", type:"常夜", dlc:false, img:"https://media.fromsoftware.jp/nightreign/resources/images/gallery/pc/screenshot/003@0.75x.jpg" },
    { name:"常夜②", type:"常夜", dlc:false, img:"https://media.fromsoftware.jp/nightreign/resources/images/gallery/pc/screenshot/003@0.75x.jpg" },
    { name:"常夜③", type:"常夜", dlc:false, img:"https://media.fromsoftware.jp/nightreign/resources/images/gallery/pc/screenshot/003@0.75x.jpg" },

    // 深き夜（モード枠）
    { name:"深き夜", type:"深き夜", dlc:false, img:"https://media.fromsoftware.jp/nightreign/resources/images/article/250828_1/pc/02@0.75x.jpg" }
  ];
